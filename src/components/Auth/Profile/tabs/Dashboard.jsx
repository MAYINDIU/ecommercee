...
export default function Dashboard() {
  ...
  useEffect(() => {
    fetch(
      `http://habib.munihaelectronics.com/public/api/order_count_statuswise/${userId}/1`
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      `http://habib.munihaelectronics.com/public/api/order_count_statuswise/${userId}/2`
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      `http://habib.munihaelectronics.com/public/api/order_count_statuswise/${userId}/3`
    )
      .then((res) => res.json())
